...
\date{xvalen29@stud.fit.vutbr.cz}
\maketitle
...
% Centered scaled section
\begin{center}
\begin{minipage}[t]{0.81\linewidth}

\quad Čím více \textit{druhů}, \textbf{řezů},  \tiny {velikostí}\normalsize, \textcolor{red}{barev} písma a jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude
\textbf{ {\fontfamily{pzc}\selectfont
dokument} }
vypadat.
\Huge{Č}\huge{t}\LARGE{e}\Large{n}\large{á}\normalsize{ř} \small{t}\scriptsize{í}\tiny{m} \normalsize{bude vždy} \textbf{\Huge{nadšen!} }
